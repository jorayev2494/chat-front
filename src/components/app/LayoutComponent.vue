<template>
    <div class="layout-wrapper d-lg-flex">
        ...
        <sidebar-component :componentChecked="checkTabPanel"></sidebar-component>
        ...
        <div class="user-chat w-100 overflow-hidden">
            ...
            <chat-content-component></chat-content-component>
...
<script>
    import SidebarComponent from './partisals/_sidebarComponent.vue';
    import ChatContentComponent from './chats/ChatContextComponent.vue'

    import ProfileTabPanelComponent from './panets/ProfileTabPanelComponent.vue';
    import ChatTabPanelComponent from './panets/ChatTabPanelComponent.vue';
    import MinMessageComponent from './chats/messages/MessageComponent.vue';

    export default {
        name: 'LayoutComponent',
        data() {
            return {
                componentName: "ChatTabPanelComponent"
            }
        },
        methods: {
