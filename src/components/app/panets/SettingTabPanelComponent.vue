                                ...
                                <div>
                                    ...
                                    <div class="d-flex align-items-center flex-wrap gap-2 theme-btn-list theme-color-list">
                                        <div class="form-check">
                                            <input class="form-check-input theme-color" type="radio" name="bgcolor-radio" id="bgcolor-radio1">
                                            <label class="form-check-label avatar-xs" for="bgcolor-radio1">
                                                <span class="avatar-title bg-blue rounded-circle theme-btn bgcolor-radio1"></span>
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input theme-color" type="radio" name="bgcolor-radio" id="bgcolor-radio2">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input theme-color" type="radio" name="bgcolor-radio" id="bgcolor-radio4">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input theme-color" type="radio" name="bgcolor-radio" id="bgcolor-radio5">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input theme-color" type="radio" name="bgcolor-radio" id="bgcolor-radio6">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input theme-color" type="radio" name="bgcolor-radio" id="bgcolor-radio7">
                            ...
                            <div class="accordion-body">
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item py-3 px-0 pb-0">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1 overflow-hidden">
                                                <h5 class="font-size-13 mb-0 text-truncate">Channels</h5>
